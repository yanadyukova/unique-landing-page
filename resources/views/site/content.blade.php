                        ...
                        <div class="inner_section">
                            <div class="row">
                                ...
                                <div class=" col-lg-7 col-md-7 col-sm-7 col-xs-12 pull-left">
                                    ...
                                    <div class="work_bottom"> <span>Want to know more..</span> <a href="{{ route('page', array('array'=>$page->alias)) }}" class="contact_btn">Contact Us</a> </div>
                                </div>
                            </div>
                        </div>
                    </div>
